...
from hethongquanlyChuyenBay.models import *
...
def add_user(last_name, first_name, gender, date_of_birth, identity_card, avatar, phone, ):
...
#
#
def register_customer(last_name, first_name, gender, date_of_birth, identity_card,  avatar, phone, username, password):
    add_user(last_name=last_name, first_name=first_name, gender=gender, date_of_birth=date_of_birth,
             identity_card=identity_card, avatar=avatar,
            phone=phone)
...
def add_seat_class(flight_id, business, economy):
    seat_class1 = SeatClass(flight_id=flight_id, seat_type=1, seat_number=business)
    seat_class2 = SeatClass(flight_id=flight_id, seat_type=2, seat_number=economy)
...
def add_transit_airport(transit_airport_id, flight_id, timing_point, arrival_day=None):
    transit_airport = TransitAirport(transit_airport_id=transit_airport_id, flight_id=flight_id,
                                     timing_point=timing_point, arrival_day=arrival_day)
...
# def get_flight_status( time=None, flight_id=None):
